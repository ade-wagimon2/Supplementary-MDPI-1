...
conf_path = os.path.join(script_dir, 'CRTB_COMPLEX_FPP_seed_42_sample_1_confidences.json')
pdb_path = os.path.join(script_dir, 'CRTB_COMPLEX_FPP_seed_42_sample_1_model.pdb')
...
ax1.set_title('pLDDT per Residue/Token', fontsize=22, fontweight='bold', pad=20)
...
ax2.set_title('Predicted Distance Error (PDE)', fontsize=22, fontweight='bold', pad=20)
